 ...
 */
package org.apache.nifi.generator;
...
public class GenerateFlowFile extends AbstractProcessor {
    ...
    public static final PropertyDescriptor MIME_TYPE = new PropertyDescriptor.Builder()
            ...
            .addValidator(StandardValidators.NON_EMPTY_VALIDATOR)
            .build();
    public static final PropertyDescriptor FILE_LIMIT = new PropertyDescriptor.Builder()
            .name("File Limit")
            .description("The number of FlowFiles to be transferred in total. A value of zero effectively ignores this property.")
            .required(false)
            .addValidator(StandardValidators.POSITIVE_INTEGER_VALIDATOR)
            .build();
